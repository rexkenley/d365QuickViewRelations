...
import QuickViewRelations from "../src/jsx/quickViewRelations";

export class QuickViewRelations
  ...
  public init(
    ...
    const { parameters, mode } = context,
      { primaryEntityId, relationship } = parameters,
    ...
    ReactDOM.render(
      // @ts-ignore
      React.createElement(QuickViewRelations, {
        context,
        isControlDisabled: this.isControlDisabled,
        primaryEntityId: primaryEntityId.raw,
